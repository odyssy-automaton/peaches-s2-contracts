...
contract PeachTycoonPruner is ReentrancyGuard, Initializable, Ownable {
    string public constant name = "PeachTycoonPrunerS3";

    uint256 public pruneEnd = 1754008200;
    uint256 public prunePrice = 25000000000000000;
    uint256 public prunePriceERC20 = 75000000;
